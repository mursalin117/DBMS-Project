...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="middle">
      <h2>Log in Page (Register)</h2>
      <hr>
      <p class="one">Welcome. Please log in to contune.</p>
      <br>
      <form action="reg_login_result.php" method="post">
        <p>Register Name: <input type="text" name="userName" placeholder="Enter user name"></p>
      ...
      <p>or, Don't have an account? <a href="../login/signup_page.php">Sign up</a></p>
    </div>
