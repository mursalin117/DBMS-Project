  ...
  <body>
    ...
    <?php
      ...
      try {
        ...
        $bookReturn = $_SESSION['info'];
        // echo "$usrName";
        $result = $conn->query("SELECT usrName, bookCode, bookName, bookReturn FROM bookInfo NATURAL JOIN book WHERE usrName = '$usrName' AND bookReturn = '$bookReturn'");
