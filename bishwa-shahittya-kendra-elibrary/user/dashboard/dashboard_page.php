  ...
  <body>
    ...
    <?php
      ...
      try {
        ...
        echo "$usrName";
        $result = $conn->query("SELECT usrName, bookCode, bookName, bookReturn FROM bookInfo NATURAL JOIN book WHERE usrName = '$usrName'");
    ...
    <div class="middle">
      ...
      <div class="content">
        ...
        <h2>Pesonal book info</h2>
        <form action="info_check.php" method="post">
          <button type="submit" name="button" value="1">Returned book</button>
          <button type="submit" name="button" value="2">Not returned book</button>
        </form>
        <h2>User Data</h2>
