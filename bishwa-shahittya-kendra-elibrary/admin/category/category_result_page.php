  ...
  <body>
    ...
    <?php
      ...
      try {
        ...
        $value = $_POST['button'];
        $result = $conn->query("SELECT bookCode, bookName, bookWriter, bookPublication, bookEdition, bookCategory, bookAvailability, bookLocation, bookPrice
          FROM book
          WHERE bookCategory = '$value'");
    ...
    <div class="middle">
      <div class="sidebar">
        ...
        <form action="category_result_page.php" method="post">
          <?php
