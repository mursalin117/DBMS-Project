  ...
  <body>
    ...
    <?php
      ...
      try {
        ...
        $result = $conn->query("SELECT bookCode, bookName, bookWriter, bookPublication, bookEdition, bookCategory, bookAvailability, bookLocation, bookPrice FROM book");
    ...
    <div class="topnav">
      ...
      <a href="./user-info/user_info_page.php">User Info</a>
