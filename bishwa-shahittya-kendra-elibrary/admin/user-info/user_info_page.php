  ...
  <body>
    ...
    <?php
      ...
      try {
        ...
        $result = $conn->query("SELECT usrName, bookCode, bookName, bookReturn FROM bookInfo NATURAL JOIN book ORDER BY usrName");
    ...
    <div class="middle">
      ...
      <div class="content">
        ...
        <h2>For Inserting data or Update</h2>
        <form action="user_info_check.php" method="post">
          <button type="submit" name="button" value="1">Insert Data</button>
          <button type="submit" name="button" value="2">Update Data</button>
        </form>
        <h2>User Data</h2>
          ...
          if ($result->rowCount() > 0) {
            ...
            foreach ($result as $row) {
              echo "<tr>";
                ...
                echo "<td>$row[bookReturn]</td>";
              echo "</tr>";
            }
            echo "</table>";
          }
          else {
            echo "<p><b>Nothing found</b></p>";
          }
        ?>
